...
export default function Hero() {
  return (
    ...
    >
      <div className="absolute inset-0 -z-20 bg-cover bg-center" />
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center text-white">
        <h1 className="fontHeading text-[clamp(2.5rem,6vw,6rem)] font-bold tracking-tight leading-[1.05]">
          Océanos vivos, futuro posible
        </h1>

        <p className="mt-6 text-base text-white/90 sm:text-lg">
          Cada año millones de toneladas de plástico, aguas residuales y
          químicos llegan al mar. Aquí verás el problema en cifras, sus causas
          y—sobre todo—qué puedes hacer hoy para revertirlo.
        </p>
